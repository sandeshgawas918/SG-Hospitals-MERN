...
const Table = React.forwardRef(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-auto text-center">
    <table
      ref={ref}
      className={cn("w-full caption-bottom text-sm shadow-md text-center border", className)}
      {...props} />
  </div>
))
...
const TableRow = React.forwardRef(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b transition-colors data-[state=selected]:bg-muted hover:bg-muted/50 text-center",
      className
    )}
    {...props} />
))
